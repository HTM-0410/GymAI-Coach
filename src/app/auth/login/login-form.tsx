...
export default function LoginForm() {
  ...
  async function signInWithGoogle() {
    ...
    try {
      ...
      setOauthError('Không thể kết nối Google. Vui lòng thử lại.');
    } finally {
      setOauthLoading(false);
    }
  }

  const error = passwordError ?? oauthError ?? state.error;

  return (
    <form action={formAction} onSubmit={handleClientSubmit} className="space-y-5">
        <div>
