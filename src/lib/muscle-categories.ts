...
export const MUSCLE_CATEGORIES: MuscleCategory[] = [
  {
    ...
    name_vi: 'Vai',
    keywords: ['vai', 'delta'],
    imagePath: '/muscle-groups/full/shoulders.png',
    intensity: 3,
  },
  {
    id: 'chest',
    name_vi: 'Ngực',
    keywords: ['ngực'],
    imagePath: '/muscle-groups/full/chest.png',
    intensity: 3,
  },
  {
    id: 'back',
    ...
    imagePath: '/muscle-groups/full/back.png',
    intensity: 3,
  },
  {
    id: 'triceps',
    ...
    imagePath: '/muscle-groups/full/triceps.png',
    intensity: 2,
  },
  {
    id: 'abs',
    ...
    imagePath: '/muscle-groups/full/core.png',
    intensity: 2,
  },
  {
    id: 'legs',
    ...
    imagePath: '/muscle-groups/full/quads.png',
    intensity: 3,
  },
  {
    id: 'glutes',
    name_vi: 'Mông',
    keywords: ['mông', 'glute'],
    imagePath: '/muscle-groups/full/glutes.png',
    intensity: 2,
  },
  {
    id: 'biceps',
    ...
    imagePath: '/muscle-groups/full/biceps.png',
    intensity: 1,
  },
  {
    id: 'forearms',
    ...
    imagePath: '/muscle-groups/full/forearms.png',
    intensity: 1,
  },
];
